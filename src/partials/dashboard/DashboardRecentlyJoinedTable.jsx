...
import DashboardRecentlyJoinedTableItem from "./DashboardRecentlyJoinedTableItem";
import Pagination from "../users/pagination";

function DashboardRecentlyJoinedTable() {
        ...
        <div className="bg-white dark:bg-gray-800  rounded-2xl relative ">
          <div>
            ...
            <div className="overflow-x-auto rounded-2xl px-7">
              <h3 className="text-lg font-semibold text-[#212121] mt-5">
                Recently Joined
              </h3>
              <table className="table-auto w-full dark:text-gray-300 divide-y divide-gray-100 dark:divide-gray-700/60 -11">
                ...
                {invitedUsers?.data?.map((user) => {
                  return (
                    <DashboardRecentlyJoinedTableItem
                      key={user.reference}
                      id={user.reference}
...
export default DashboardRecentlyJoinedTable;
