    ...
    <>
                ...
                <main className="flex-1 space-y-6 pb-5">
                  ...
                  <div className="bg-white rounded-2xl p-6">
                    ...
                    <p className="text-[#141414] text-base">
                      Hi, I'm Nylah Whitehead. I am deeply committed to
                      fostering innovation, driving sustainable growth, and
                      nurturing a culture of continuous improvement and
                      excellence. With a strategic mindset, I focus on
                      delivering exceptional value and empowering teams to excel
                      in dynamic environments. My leadership philosophy revolves
                      around inspiring others to achieve their best, fostering
                      collaboration, and building resilient, high-performing
                      teams.
                    </p>
                  </div>
                ...
                <main className="flex-1 space-y-6 pb-5">
                  ...
                  <div className="bg-white rounded-2xl p-6">
                    ...
                    <p className="text-[#141414] text-base">
                      ...
                      efficiency, and innovation. From custom software
                      development to cloud solutions, we deliver tailored
                      strategies that address your unique needs, ensuring
                      technology becomes a strategic asset for your
                      organization. Our comprehensive services also include
                      advanced cybersecurity measures to safeguard your
                      operations and data analytics to unlock valuable insights
      ...
      <div className="m-1.5">
        ...
        <ModalBlank
          ...
          setModalOpen={openSuspendUserModal}
        >
        ...
        <ModalBlank
          ...
          setModalOpen={openActivateUserModal}
        >
          <div className="text-center flex flex-col items-center gap-2.5">
            <h3 className="text-[20px] font-bold text-[#0A0A0A]">
              Activate User
